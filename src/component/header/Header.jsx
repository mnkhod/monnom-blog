...
class Header extends Component{
    ...
    render(){
       ...
       var elements = [];
        ...
        let logoUrl;
        logoUrl = <img src="/assets/images/monnom-logo-512.png" alt="Monnom" style={{width: '100%', height: 'auto'}}/>;
                ...
                <div className="header-wrapper" id="header-wrapper">
                    <div className="header-left">
                        <div className="logo">
                            ...
                            <h2 className="logo-title">MON<span>|</span>NOM</h2>
                        </div>
                    </div>
                    <div className="header-right">
                        ...
                        <div className="header-btn">
                            <a className="rn-btn" href="https://monnom.mn">
                                <span>Эхлэл</span>
                            </a>
                        </div>
